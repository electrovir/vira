...
export const viraFormCssVars = defineCssVars({
    ...
    'vira-form-text-selection-color':
        viraTheme.colors['vira-brand-behind-bg-decoration'].background.value,
    'vira-form-selection-hover-color':
        viraTheme.colors['vira-brand-behind-bg-invisible'].background.value,
    ...
    'vira-form-positive-hover-color':
        viraTheme.colors['vira-green-behind-bg-header'].background.value,
    'vira-form-positive-active-color':
    ...
    'vira-form-accent-primary-color':
        viraTheme.colors['vira-brand-behind-bg-non-body'].background.value,
    'vira-form-accent-primary-hover-color':
        viraTheme.colors['vira-brand-behind-bg-header'].background.value,
    'vira-form-accent-primary-active-color':
        viraTheme.colors['vira-brand-behind-bg-body'].background.value,
