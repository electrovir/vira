        ...
        Object.values(allIconsByName).forEach((icon) => {
            defineExample({
                ...
                renderCallback({ controls }) {
                    const styles = css `
                        ${viraIconColorCssVars['vira-icon-color'].name}: ${unsafeCSS(controls['Icon Color'] || 'inherit')};
                        ${viraIconColorCssVars['vira-icon-fill-color'].name}: ${unsafeCSS(controls['Fill Color'] || 'inherit')};
                        ${viraIconColorCssVars['vira-icon-stroke-color'].name}: ${unsafeCSS(controls['Stroke Color'] || 'inherit')};
                    `;
                    return html `
